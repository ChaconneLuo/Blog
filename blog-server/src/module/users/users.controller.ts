...
export class UsersController {
  ...
  @Post('/register')
  async register(@Body() user: UsersCreateDto): Promise<Return<UsersReturnDto>> {
    const result: UsersReturnDto = deleteProperty<User, UsersReturnDto>(await this.usersService.insert(user), [
      'id',
      'created',
      'updated',
      'password'
  ...
  async getInfo(@Req() req: RequestWithUser): Promise<Return<UsersReturnDto>> {
    const result: UsersReturnDto = deleteProperty<User, UsersReturnDto>(await this.usersService.getInfo(req.user!.email), [
      'id',
      'created',
      'updated',
      'password'
